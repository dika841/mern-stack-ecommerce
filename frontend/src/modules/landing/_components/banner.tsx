...
const Banner = () => {
  ...
  return (
    <SectionLayout>
      <div className="relative w-full overflow-hidden rounded-lg bg-gradient-to-r from-primary to-violet-600 p-8 text-white shadow-xl">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -right-8 -bottom-8 h-32 w-32 animate-pulse rounded-full bg-primary opacity-20 delay-300"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-between space-y-6 md:flex-row md:space-y-0">
          ...
          >
            ...
            <p className="mt-3 max-w-md text-sm text-blue-100 md:text-base">
              Exclusive designs at special introductory prices. Limited time
              offer ending soon. Don&apos;t miss out.
            </p>
          </div>
